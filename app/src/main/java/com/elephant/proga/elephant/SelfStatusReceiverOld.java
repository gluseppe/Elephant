 ...
 */
public class SelfStatusReceiverOld implements Runnable {

    private NavigationMapActivity activity;
    private String selfposition;

    public SelfStatusReceiverOld(NavigationMapActivity activity) {
        ...
        while(true) {
            ...
            this.activity.runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    try {
                        JSONObject jObj = new JSONObject(selfposition);
                        activity.onSelfUpdate(jObj);
